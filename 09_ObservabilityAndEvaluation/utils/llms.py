...
# 从 langchain_huggingface 包中导入 HuggingFaceEmbeddings，用于���地向量嵌入
...
MODEL_CONFIGS = {
    ...
    "openai": {
        ...
        # 向量嵌入模型名称（本地 HuggingFace，此字段仅作标识）
...
def get_llm(llm_type: str = DEFAULT_LLM_TYPE) -> tuple[ChatOpenAI, HuggingFaceEmbeddings]:
    """
    ...
    Returns:
        tuple[ChatOpenAI, HuggingFaceEmbeddings]: LLM与Embedding实例
    """
    try:
